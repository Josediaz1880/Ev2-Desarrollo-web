...
urlpatterns = [
    ...
    path('categorias/', categorias_list, name='categorias'),
    path('categorias/agregar/', crearCategoria, name='crearCategoria'),
    path('categorias/editar/<int:id>/', editarCategoria, name='editarCategoria'),
